import 'package:bloc_learning/features/auth/presentation/fikrim_yoxdu_page.dart';
        ...
        body: BlocConsumer<SplashBloc, SplashState>(
          listener: (context, state) {
            if (state is SplashLoaded) {
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => FikrimYoxduPage()));
